...
plot(beta, rhoUS, '-o', 'Color', c.vermilion, 'MarkerSize', 4,'MarkerFaceColor', c.vermilion);
plot(beta, rhoAS, '-^', 'Color', c.blue,'MarkerSize', 4,      'MarkerFaceColor', c.blue);
plot(beta, rhoAG, '-v', 'Color', c.green,'MarkerSize', 4,     'MarkerFaceColor', c.green);
